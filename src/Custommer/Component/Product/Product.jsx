            ...
            <div>
                <main className="mx-auto px-4 sm:px-6 lg:px-20">
                    ...
                    <section aria-labelledby="products-heading" className="pb-24 pt-6">
                        <h1 className="text-4xl font-bold tracking-tight text-gray-900">Bộ sưu tập</h1>
                        ...
                        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                            ...
                            <form className="hidden lg:block">
                                                            ...
                                                            v.child.map((c) => (
                                                                <TreeItem
                                                                    ...
                                                                    label={
                                                                        <p
                                                                            className={cl({
                                                                                "text-red-500": query?.categoryId === c.id,
                                                                            })}
                                                                        >
                                                                            {c.title}
                                                                        </p>
                                ...
                                <div className="mt-3 bg-white shadow p-6 rounded-lg">
                                    <FormControl sx={{ m: 1, minWidth: 120 }} size="small" className="w-full">
                                        <InputLabel className="text-gray-700" id="demo-select-small-label">
                                            Color
                                        </InputLabel>
                                        <Select
                                            labelId="demo-select-small-label"
